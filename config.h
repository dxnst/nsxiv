...
#if HAVE_LIBFONTS
static const char *DEFAULT_BAR_BG     = "#88c0d0";  /* NULL means it will default to window background */
static const char *DEFAULT_BAR_FG     = "#2e3440";  /* NULL means it will default to window foreground */
static const char *DEFAULT_FONT       = "Agave-8";
